...
export class RegistroMedicoControllerService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  obtenerRegistrosMedicos$Response(params: ObtenerRegistrosMedicos$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<RegistroMedicoRes>>> {
   ...
   * This method doesn't expect any request body.
   */
  obtenerRegistrosMedicos(params: ObtenerRegistrosMedicos$Params, context?: HttpContext): Observable<Array<RegistroMedicoRes>> {
    return this.obtenerRegistrosMedicos$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<RegistroMedicoRes>>): Array<RegistroMedicoRes> => r.body)
    );
  }
