...
export function obtenerRegistrosMedicos(http: HttpClient, rootUrl: string, params: ObtenerRegistrosMedicos$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<RegistroMedicoRes>>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<RegistroMedicoRes>>;
    })
  );
}
