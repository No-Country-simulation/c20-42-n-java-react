...
import { DoctorUserHeaderComponent } from './shared/components/doctor-user-layout/doctor-user-header/doctor-user-header.component';
import { DoctorUserFooterComponent } from './shared/components/doctor-user-layout/doctor-user-footer/doctor-user-footer.component';
import { DoctorUserSidebarComponent } from './shared/components/doctor-user-layout/doctor-user-sidebar/doctor-user-sidebar.component';
